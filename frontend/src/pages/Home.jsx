        ...
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
          ...
          <div>
            <div className='lg:w-[570px]'>
              <h1 className='text-[25px] leading-[46px] text-blue-500 font-[800] md:text-[60px] md:leading-[70px]'>
              तपाईंको स्वास्थ्य,<span className='text-fuchsia-500'> तपाईंको समय,</span> <span className='text-yellow-500'>हाम्रो प्राथमिकता।</span>
              </h1>
              <p className="text__para text-[18px] font-semibold">
              Our Doctor Appointment System is designed to put your health first.
               Effortlessly book appointments, find the right healthcare 
               professionals, and take control of your well-being with user-friendly
                features.
              </p>
